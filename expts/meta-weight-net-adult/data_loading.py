...
def load_image_data(data_name, dict_no, noise_rate,epoch):
  ...
  np.savez_compressed('./data_files/train{}.npz'.format(epoch),
                      x_train=x_train, y_train=y_train)
  np.savez_compressed('./data_files/valid{}.npz'.format(epoch),
                      x_valid=x_valid, y_valid=y_valid)
  np.savez_compressed('./data_files/test{}.npz'.format(epoch),
