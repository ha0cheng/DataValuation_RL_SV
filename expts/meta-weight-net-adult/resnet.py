...
class VNet(MetaModule):
    def __init__(self, input, hidden1, output, scale_factor):
...
class weight_net_scale(MetaModule):
    def __init__(self, input_size, hidden1, hidden2, output_size, scale_factor):
        super(weight_net_scale, self).__init__()
        self.scale_factor = scale_factor
        self.linear1 = MetaLinear(input_size, hidden1)
        self.relu1 = nn.ReLU(inplace=True)
        self.linear2 = MetaLinear(hidden1, hidden2)
        self.linear3 = MetaLinear(hidden2, output_size)
